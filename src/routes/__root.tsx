...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "IHWT — International Health, Wellness & Tourism Federation" },
      { name: "description", content: "Connecting global healthcare, wellness and medical tourism ecosystems through events, partnerships and innovation." },
      { property: "og:title", content: "IHWT — International Health, Wellness & Tourism Federation" },
      { property: "og:description", content: "Connecting global healthcare, wellness and medical tourism ecosystems through events, partnerships and innovation." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "IHWT Federation" },
